      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="card card-secondary add-new-employee">
               ...
               <div class="card-body">
                  <form action="{{ route('admin.update.category', $category_detail->id) }}" method="POST" enctype="multipart/form-data">
                     @csrf
                     <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" id="name" name="name" class="form-control" value="{{ $category_detail->name }}" placeholder="Enter Name"/>
                     </div>
                     <div class="form-group">
                        <label>Date</label>
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                           <input type="text" class="form-control datetimepicker-input" name="date" data-target="#reservationdate" value="{{ $category_detail->date }}"/>
